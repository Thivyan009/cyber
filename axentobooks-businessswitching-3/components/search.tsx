          ...
          <CommandEmpty>
            {searchQuery ? (
              <div className="p-6 text-center">
                <p className="text-sm text-muted-foreground">No transactions found matching "{searchQuery}"</p>
                <p className="text-xs text-muted-foreground mt-2">Try searching with different keywords</p>
              </div>
            ) : (
              <div className="p-6 text-center">
                <p className="text-sm text-muted-foreground">Type to search transactions</p>
                <p className="text-xs text-muted-foreground mt-2">Search by name, category, type, amount, or date</p>
              </div>
            )}
          </CommandEmpty>
